...
"Took from some geek I cant remember and a few ajusts by myself
 if exists('$TMUX')
   let &t_SI = "\<Esc>Ptmux;\<Esc>\<Esc>]12;orange\x7\<Esc>\\"
   let &t_EI = "\<Esc>Ptmux;\<Esc>\<Esc>]12;gray\x7\<Esc>\\"
   silent !echo -ne "\<Esc>Ptmux;\<Esc>\<Esc>\033]12;gray\007\<Esc>\\"
   autocmd VimLeave * silent !echo -ne "\<Esc>Ptmux;\<Esc>\<Esc>\033]112\007\<Esc>\\"
"   
else
" if &term =~ "xterm\\|rxvt"
...
map <C-l> <C-W>l
"
" Close the current buffer/deprecated
